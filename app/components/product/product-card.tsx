...
export function ProductCard({
  ...
  return (
    <div
      className={clsx(
        "group rounded-(--pcard-radius) flex flex-col",
        className,
      )}
      style={
        {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <RevealUnderline className="bg-position-[left_calc(1em+3px)] leading-normal line-clamp-1 group-hover:bg-size-[100%_1px]">
              {product.title}
            </RevealUnderline>
          </Link>
